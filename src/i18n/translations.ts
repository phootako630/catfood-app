...
export const translations = {
  zh: {
    ...
    setup: {
      ...
      familyName: '家庭名称', familyNamePlaceholder: '如：我家',
      familyNameHint: '不填会自动生成',
    ...
    settings: {
      ...
      editName: '修改昵称', namePlaceholder: '输入新昵称',
      nameEmpty: '昵称不能为空', nameUpdated: '昵称已更新',
    },
  ...
  en: {
    ...
    setup: {
      ...
      familyName: 'Family Name', familyNamePlaceholder: 'e.g. The Smiths',
      familyNameHint: 'Leave blank to auto-generate',
    ...
    settings: {
      ...
      editName: 'Edit Name', namePlaceholder: 'Enter new name',
      nameEmpty: 'Name cannot be empty', nameUpdated: 'Name updated',
    },
